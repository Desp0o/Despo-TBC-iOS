...
//let randomDouble = (Double.random(in: 0...1) * 10).rounded() / 10
...
//            return "\(self) with rarity \(rarity)"
//        default:
//            return "no creature"
//        }
//    }
...
print("despo")
print("ბიბლიოთეკაში ყველაზე პოპულარული ავტორი არის: ")
print("ბიბლიოთეკაში ყველაზე პოპულარული ავტორი ")
